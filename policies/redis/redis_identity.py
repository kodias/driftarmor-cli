"""CKV_DRIFTARMOR_REDIS_4 — redis.identity (warn on fail in mapper)."""
...
class RedisIdentity(BaseResourceCheck):
    def __init__(self) -> None:
        super().__init__(
            name="Managed Redis has a managed identity",
            id="CKV_DRIFTARMOR_REDIS_4",
