...
CHECKOV_TO_PRODUCT: dict[str, str] = {
    ...
    "CKV_DRIFTARMOR_REDIS_4": "redis.identity",
}
...
PACK_AUTO_RULES: dict[str, tuple[str, ...]] = {
    ...
    "redis": (
        "redis.public_network",
        "redis.client_protocol",
        "redis.access_keys_auth",
        "redis.identity",
    ),
    "keyvault": (
...
RULE_REQUIRES_TYPES: dict[str, frozenset[str]] = {
    ...
    "servicebus.local_authentication": frozenset({"azurerm_servicebus_namespace"}),
    "servicebus.min_tls": frozenset({"azurerm_servicebus_namespace"}),
    "servicebus.network_restricted": frozenset({"azurerm_servicebus_namespace"}),
}
...
FAIL_SEVERITY: dict[str, Severity] = {
    ...
    "redis.public_network": "fail",
    "redis.client_protocol": "fail",
    "redis.access_keys_auth": "fail",
    "redis.identity": "warn",
    "keyvault.rbac_authorization": "fail",
    "keyvault.purge_protection": "fail",
    "keyvault.network_restricted": "warn",
    "acr.admin_disabled": "fail",
    "acr.anonymous_pull_disabled": "fail",
    "acr.network_restricted": "warn",
    "servicebus.local_authentication": "fail",
    "servicebus.min_tls": "fail",
    "servicebus.network_restricted": "warn",
...
DEFAULT_TITLES: dict[str, str] = {
    ...
    "redis.public_network": "Managed Redis public network access disabled",
    "redis.client_protocol": "Managed Redis client protocol is Encrypted",
    "redis.access_keys_auth": "Managed Redis access key authentication disabled",
    "redis.identity": "Managed Redis has a managed identity",
    "keyvault.rbac_authorization": "Key Vault uses Azure RBAC authorization",
    "keyvault.purge_protection": "Key Vault purge protection enabled",
    "keyvault.network_restricted": "Key Vault public access disabled or network ACLs deny by default",
    "acr.admin_disabled": "Container Registry admin account disabled",
    "acr.anonymous_pull_disabled": "Container Registry anonymous pull disabled",
    "acr.network_restricted": "Container Registry public access disabled or network rules deny by default",
    "servicebus.local_authentication": "Service Bus local/SAS authentication disabled",
    "servicebus.min_tls": "Service Bus minimum TLS 1.2",
    "servicebus.network_restricted": "Service Bus public access disabled or network rules deny by default",
...
DEFAULT_FAIL_DETAIL: dict[str, str] = {
    ...
    "redis.public_network": "public_network_access is Enabled or unset (default Enabled)",
    "redis.client_protocol": "default_database.client_protocol is Plaintext",
    "redis.access_keys_auth": "default_database.access_keys_authentication_enabled is true",
    "redis.identity": "identity block missing or type unset",
    "keyvault.rbac_authorization": "rbac_authorization_enabled / enable_rbac_authorization is not true",
    "keyvault.purge_protection": "purge_protection_enabled is not true",
    "keyvault.network_restricted": "public network access is enabled and network_acls default_action is not Deny",
    "acr.admin_disabled": "admin_enabled is true",
    "acr.anonymous_pull_disabled": "anonymous_pull_enabled is true",
    "acr.network_restricted": "public network access is enabled and network_rule_set default_action is not Deny",
    "servicebus.local_authentication": "local_auth_enabled is not false",
    "servicebus.min_tls": "minimum_tls_version is below 1.2 or unset",
    "servicebus.network_restricted": "public network access is enabled and no namespace network-rule set defaults to Deny",
